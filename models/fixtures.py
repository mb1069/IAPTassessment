...
i = 1
# db.auth_user.insert(id=i, first_name='dadude941', last_name='User %s' % i, email='test_email_%s@sososofake.com' % i, password=crypt('password%s' % i)[0])
...
if db(db.comicbox.id > 0).count() == 0:
    ...
    db.comicbook.insert(box_id=1, title='Superman1', publisher=1, cover=open(cover_path))
